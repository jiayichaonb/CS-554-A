$(function () {
  ...
  QUnit.test('should allow accordion to use children other than card', function (assert) {
    ...
    var accordionHTML = '<div id="accordion">' +
        ...
        '<div id="collapseOne" class="collapse" role="tabpanel" See details="headingThree" data-parent="#accordion"></div>' +
        '</div>' +
        '<div class="item">' +
        '<a id="linkTriggerTwo" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>' +
        '<div id="collapseTwo" class="collapse show" role="tabpanel" See details="headingTwo" data-parent="#accordion"></div>' +
        '</div>' +
        '</div>'
  ...
  QUnit.test('should collapse accordion children but not nested accordion children', function (assert) {
    ...
    $('<div id="accordion">' +
        '<div class="item">' +
        '<a id="linkTrigger" data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>' +
        '<div id="collapseOne" data-parent="#accordion" class="collapse" role="tabpanel" See details="headingThree">' +
        ...
        '<div id="nestedCollapseOne" data-parent="#nestedAccordion" class="collapse" role="tabpanel" See details="headingThree">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<div class="item">' +
        '<a id="linkTriggerTwo" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>' +
        '<div id="collapseTwo" data-parent="#accordion" class="collapse show" role="tabpanel" See details="headingTwo"></div>' +
        '</div>' +
